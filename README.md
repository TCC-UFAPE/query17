# Query11 - Análise Completa de Vulnerabilidades do linux kernel

## Descrição

A **Query11** é um script Python que combina as funcionalidades das queries 7 e 10 para realizar uma análise abrangente das vulnerabilidades do projeto **linux kernel**, integrando dados de documentação com informações detalhadas dos commits do GitHub.
...
- **Filtro**: Apenas projeto linux kernel
...
| Coluna | Descrição |
|--------|-----------|
| Projeto | Nome do projeto (linux kernel) |
...
2. **Filtra vulnerabilidades** do linux kernel
...
- ✅ **Análise focada** no projeto linux kernel
